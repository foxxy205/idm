...
const Project = [
    ...
    },
    {
        ...
        slug: 'Uniswap (UNI) Airdrop',
        sub: 'Case study',
        // Industry: 'Wellness & Fitness',
        // Country: 'Canada, Alberta',
        // Technologies1: tImg1,
        // Technologies2: tImg3,
        description: 'Uniswap, a leading decentralized exchange (DEX) on the Ethereum blockchain, conducted one of the most iconic airdrops in crypto history in September 2020. The airdrop distributed UNI governance tokens to early users of the platform, rewarding those who had interacted with Uniswap before a specific cutoff date.',
    },
    {
        Id: '9',
        pImg: pImg6,
        title: 'Arbitrum (ARB) Airdrop',
        slug: 'Arbitrum (ARB) Airdrop',
        sub: 'Case study',
        // Industry: 'Real estate',
        // Country: 'France, Paris',
        // Technologies1: tImg4,
        // Technologies2: tImg5,
        description: ' Arbitrum, a leading Ethereum Layer-2 scaling solution, executed a highly successful airdrop in March 2023 to reward early adopters and drive adoption of its platform. Arbitrum aims to reduce Ethereum’s high transaction fees and congestion by processing transactions off-chain while maintaining security through Ethereum’s mainnet.',
    },
    {
        Id: '10',
        pImg: pImg7,
